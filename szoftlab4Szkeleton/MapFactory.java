...
public class MapFactory {
	...
	/**
	 * A pálya felépítéséért, és a Robotok kezdõpozíciójáért felelõs osztály
	 */
	public MapFactory() {
	 ...
	 * Eltárolja a lehetséges kezdõpozíciókat.
	 */
	...
	/**
	 * Visszaad egy olyan Tile objektumot, ami a Robot kezdõpozíciójául szolgálhat.
	 * Ameddig tud, az elõzõektõl eltérõ mezõvel tér vissza
	 * 
	 * @return A kezdõ mezõ.
	 */
